      ...
      <div className="relative mx-auto max-w-3xl px-6 text-center">
        ...
        <FadeUp delay={0.3}>
          <div className="mt-8 flex flex-col flex-wrap gap-4 sm:flex-row sm:justify-center">
            <a
              href="https://github.com/0x99M/project-y/releases/download/v3.0.3/clipmer_3.0.3_amd64.deb"
              className={cn(
            ...
            <a
              href="https://github.com/0x99M/project-y/releases/download/v3.0.3/clipmer-3.0.3.x86_64.rpm"
              className={cn(
            ...
            <a
              href="https://github.com/0x99M/project-y/releases/download/v3.0.3/Clipmer-3.0.3.AppImage"
              className={cn(
                buttonVariants({ variant: "outline", size: "lg" }),
                "h-14 gap-2 px-8 text-base border-border hover:bg-surface"
              )}
